...
# --- Configuracion del Benchmark: 607.cactuBSSN_s ---
# Ruta segun tu indicacion
base_path = "/scratch/rrodriguez/SPEC2017/607.cactuBSSN_s"
executable = base_path + "/cactuBSSN_s_base.x86-64" # Ajustar al nombre real del binario
input_file = base_path + "/spec_train.par"

process = Process()
process.executable = executable
# Comando: ejecutable + archivo de parametros .par
process.cmd = [executable, input_file]
process.cwd = base_path # Importante para que encuentre archivos locales
