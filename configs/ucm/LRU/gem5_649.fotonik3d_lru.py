...
# --- Configuracion de SPEC 2017: 649.fotonik3d_s ---
# Ruta segun tu indicacion
base_path = "/scratch/rrodriguez/SPEC2017/649.fotonik3d_s"
executable = f"{base_path}/fotonik3d_s_base.x86-64"
process = Process()
# Buscamos el ejecutable dentro de la carpeta (el nombre exacto depende de tu compilacion)
# Normalmente termina en _base.x86_64 o similar
process.executable = executable 

# Comando para 649.fotonik3d_s con entrada train:
# El benchmark busca el archivo 'yee.dat' en el directorio de trabajo.
