...
# --- Configuracion del Benchmark 638.imagick_s (Train) ---
# Ubicacion segun tu ruta especificada
base_path = '/scratch/rrodriguez/SPEC2017/638.imagick_s'
executable = os.path.join(base_path, 'imagick_s_base.x86-64') # Ajustar nombre exacto del binario si varia

process = Process()
process.executable = executable

# Comando para dataset 'train': 
# El benchmark imagick suele requerir un archivo de entrada y parametros de transformacion
# Los argumentos tipicos de SPEC2017 train son: input_file -limit disk 0mb resample 25% output_file
process.cmd = [executable, '-limit', 'disk', '0', 'train_input.tga', '-resize', '320x240', '-shear', '31', '-edge', '140', '-negate', '-flop', '-resize', '900x900', '-edge', '10', 'train_output.tga']
