...
# --- Configuracion del Benchmark 631.deepsjeng_s ---
# Ruta segun tus especificaciones
#base_path = "/scratch/rrodriguez/SPEC2017/631.deepsjeng_s"
## El binario suele tener un nombre similar a deepsjeng_s_base.x86_64 o similar
## Asegurate de que el nombre del ejecutable coincida exactamente con el de tu carpeta
#executable = f"{base_path}/deepsjeng_s_base.x86-64" 
#input_file = f"{base_path}/train.txt"
#
#process = Process()
#process.executable = executable
## Comando para deepsjeng: recibe el archivo .txt con la configuracion del juego
#process.cmd = [executable, input_file]
#process.cwd = base_path

executable = '/scratch/rrodriguez/SPEC2017/631.deepsjeng_s/deepsjeng_s_base.x86-64'
process = Process()
process.executable = executable
# Comando para deepsjeng: recibe el archivo .txt con la configuracion del juego
process.cmd = [executable, 'train.txt']
process.cwd = '/scratch/rrodriguez/SPEC2017/631.deepsjeng_s/'
