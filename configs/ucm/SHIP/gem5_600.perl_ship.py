...
# --- Configuracion del Proceso (600.perl_s) ---
# Definicion de rutas segn tu especificacion
base_path = "/scratch/rrodriguez/SPEC2017/600.perlbench_s/"
executable = "/scratch/rrodriguez/SPEC2017/600.perlbench_s/perlbench_s_base.x86-64" # Ajustar nombre exacto del binario si es necesario

process = Process()
process.executable = executable
# Comando: ejecutable + script perl + parametros de entrada del dataset train
# Nota: Perlbench requiere pasar el script .pl como primer argumento
process.cmd = [executable, 'splitmail.pl', '535', '13', '25', '6', '16', '3']
process.cwd = base_path # Directorio de trabajo para que encuentre splitmail.pl
