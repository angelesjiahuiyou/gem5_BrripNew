...
# --- 4. Configuracion del Proceso (648.exchange2_s) ---
# Ruta base proporcionada
base_path = "/scratch/rrodriguez/SPEC2017/648.exchange2_s"
executable = f"{base_path}/exchange2_s_base.x86-64"
process = Process()
# Buscamos el ejecutable base compilado (ajusta el nombre exacto si varia)
process.executable = executable

# Argumentos para el dataset 'train' de 648.exchange2_s
# Basado en la definicion de SPEC2017: suele recibir un archivo de configuracion/entrada
#process.cmd = [process.executable, "sbe.in"]
process.cmd = [process.executable, "1"]

# Directorio de trabajo para que encuentre los archivos de entrada
