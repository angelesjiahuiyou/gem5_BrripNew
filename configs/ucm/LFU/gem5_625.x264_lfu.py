...
# --- 5. Configuracion del Proceso (625.x264_s Train) ---
# Ruta base proporcionada
# --- Configuracion del Proceso (625.x264_s) ---
executable = '/scratch/rrodriguez/SPEC2017/625.x264_s/x264_s_base.x86-64'
process = Process()
process.executable = executable
# Argumentos tipicos de train para x264
process.cmd = [executable, '--dumpyuv', '50', '--frames', '142', '-o', 'BuckBunny_New.264', 'BuckBunny.yuv', '1280x720']
process.cwd = '/scratch/rrodriguez/SPEC2017/625.x264_s/'
