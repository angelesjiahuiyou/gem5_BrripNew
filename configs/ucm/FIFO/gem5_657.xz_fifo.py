...
# --- 5. Configuracion del Proceso (657.xz_s Train) ---
# Ruta base proporcionada
base_path = "/scratch/rrodriguez/SPEC2017/657.xz_s"
executable = f"{base_path}/xz_s_base.x86-64"
process = Process()
# Buscamos el binario (ajusta el nombre exacto si varia segun tu compilacion)
process.executable = executable

# Argumentos para la entrada 'train' de 657.xz_s:
# Tipicamente: binario + archivo_entrada + numero_iteraciones + checksum
process.cmd = [process.executable, "input.combined.xz", "40", "a841f68f38572a49d86226b7ff5baeb31bd19dc637a922a972b2e6d1257a890f6a544ecab967c313e370478c74f760eb229d4eef8a8d2836d233d3e9dd1430bf", "6356684", "-1", "8"]

# Cambiar el directorio de trabajo para que encuentre los archivos de entrada
