...
# --- 4. Configuracion del Proceso (605.mcf_s) ---
# Definimos las rutas segun tu estructura en /scratch
spec_dir = "/scratch/rrodriguez/SPEC2017/605.mcf_s/"
executable = "/scratch/rrodriguez/SPEC2017/605.mcf_s/mcf_s_base.x86-64" # Ajusta el nombre exacto del binario si varia

process = Process()
process.executable = executable

# El benchmark 605.mcf_s recibe un archivo .in como argumento. 
# Para 'train', el archivo suele llamarse 'inp.in'
process.cmd = [executable, spec_dir + "inp.in"]
process.cwd = spec_dir # Directorio de trabajo para que encuentre archivos locales
