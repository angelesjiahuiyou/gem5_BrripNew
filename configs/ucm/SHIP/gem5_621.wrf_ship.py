...
system.mem_ranges = [AddrRange('32GB')] # ROMS requiere bastante memoria
...
system.mem_ctrl.dram = DDR4_2400_8x8(device_size='32GB')
system.mem_ctrl.dram.range = system.mem_ranges[0]
system.mem_ctrl.dram.device_size = '32GB'
system.mem_ctrl.port = system.membus.mem_side_ports

# --- 5. Configuracion del Proceso (657.xz_s Train) ---
# Ruta base proporcionada
# --- Configuracion del Proceso (621.wrf_s) ---
#executable = '/scratch/rrodriguez/SPEC2017/621.wrf_s/wrf_s_base.x86-64'
#process = Process()
#process.executable = executable
# WRF normalmente no lleva argumentos, lee 'namelist.input' del cwd
#process.cmd = [executable] 
#process.cwd = '/scratch/rrodriguez/SPEC2017/621.wrf_s/'
executable = '/scratch/rrodriguez/SPEC2017/621.wrf_s/wrf_s_base.x86-64'

process = Process(
    executable = executable,
    cmd = [executable], 
    cwd = '/scratch/rrodriguez/SPEC2017/621.wrf_s/',
    input = '/scratch/rrodriguez/SPEC2017/621.wrf_s/namelist.input'
    )
