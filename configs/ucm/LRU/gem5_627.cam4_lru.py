...
# --- Configuracion del Proceso (627.cam4_s) ---
executable = '/scratch/rrodriguez/SPEC2017/627.cam4_s/cam4_s_base.x86-64'
process = Process()
process.executable = executable
process.cmd = [executable] # Lee archivos 'atm_in' y similares del cwd
process.cwd = '/scratch/rrodriguez/SPEC2017/627.cam4_s/'
