...
# --- Configuracion de 641.leela_s (SPEC CPU 2017) ---
# Definicion de rutas segun tu estructura
base_path = "/scratch/rrodriguez/SPEC2017/641.leela_s"
# El binario suele tener un nombre largo dependiendo de la compilacion (ej. leela_s_base.x86_64)
# Asegurate de poner el nombre exacto del archivo que esta en tu carpeta
executable = f"{base_path}/leela_s_base.x86-64"

process = Process()
process.executable = executable

# Argumentos para el set 'train' de 641.leela_s
# Normalmente recibe un archivo .sgf (ej. train.sgf)
process.cmd = [process.executable, "train.sgf"]
