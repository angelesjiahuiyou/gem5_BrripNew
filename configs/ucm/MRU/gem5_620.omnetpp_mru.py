...
# --- Configuracion del Benchmark 620.omnetpp_s (Entradas Train) ---
# Definicion de rutas segun tu estructura
base_path = "/scratch/rrodriguez/SPEC2017/620.omnetpp_s/"
executable = f"{base_path}/omnetpp_s_base.x86-64" # Ajustar nombre exacto si varia

process = Process()
process.executable = executable

# Argumentos para la entrada 'train' de 620.omnetpp_s
# Nota: omnetpp requiere el archivo .ini y el archivo .xml como argumentos
process.cmd = [executable, "omnetpp.ini", "-c", "General", "-r", "0"]

# Cambiamos el directorio de trabajo para que encuentre los archivos .ini y .xml
process.cwd = base_path 
process.output = "620.omnetpp.stdout.txt"
