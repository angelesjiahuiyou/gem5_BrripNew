...
# --- 4. Configuracion de 602.gcc_s (Modo Aislado) ---
#base_path = '/scratch/rrodriguez/SPEC2017/602.gcc_s/'
#executable = base_path + 'sgcc_base.x86-64'
#
## Creamos el proceso
#process = Process()
...
#
## CLAVE: 
## 1. Usamos 'train01.i' (el pre-procesado).
## 2. Anadimos '-nostdinc' para que NO busque en /usr/include.
## 3. Anadimos '-dumpbase train01' para evitar que intente crear archivos temporales ocultos.
#process.cmd = [executable, 'train01.i', '-nostdinc', '-O3', '-o', 'train01.s']

# --- Configuracion del Proceso (602.gcc_s) ---
# Definimos la ruta al binario que extrajo tu script
executable = '/scratch/rrodriguez/SPEC2017/602.gcc_s/gcc_s_base.x86-64'
process = Process()
process.executable = executable
# Argumentos exactos para la ejecucion de train01.c
# gem5 requiere que cada flag y argumento sea un elemento separado en la lista
process.cmd = [
    executable, 
    'train01.c', 
    '-O3', 
    '-finline-limit=50000', 
    '-o', 
    'train01.opts-O3_-finline-limit_50000.s'
]

# Directorio de trabajo donde se encuentra train01.c
process.cwd = '/scratch/rrodriguez/SPEC2017/602.gcc_s/'
